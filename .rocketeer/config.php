...
//Dotenv::required(array('SSH_HOST', 'SSH_USER', 'SSH_PASSWORD'));
...
return [
    ...
    'application_name' => 'maartendekker.nl',
    ...
    'plugins'          => [// 'Rocketeer\Plugins\Slack\RocketeerSlack',
        ...
        'Rocketeer\Plugins\Wordpress\RocketeerWordpress'
    ],
    ...
    'wp_tasks' => [
        'asset_dirs'        => ['web/app/themes/maartendekker/dist', 'web/.htaccess'],
